...
class Employee(AbstractBaseUser):
    ...
    location = models.ForeignKey(Location, null=True,blank=True, verbose_name=_("location"), on_delete=models.CASCADE)
    role = models.ForeignKey(Role, null=True,blank=True,verbose_name=_("role"), on_delete=models.CASCADE)
    # employee_type = models.PositiveSmallIntegerField(null=True, blank=True, choices=EMPLOYEE_TYPE_CHOICES)
...
class EmployeeProfileImage(models.Model):
